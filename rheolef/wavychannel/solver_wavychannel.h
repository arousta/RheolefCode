 ...
 ***************************************************************************/
#ifndef SOLVER_WAVYCHANNEL_H
#define SOLVER_WAVYCHANNEL_H
...
template< class T, int depth >
inline void
solver_wavychannel::get_from_xml( path_t (&path)[depth], T *const x )
{get_value( path, parameters, x );}

template< int depth >
inline bool
solver_wavychannel::path_exist( path_t (&path)[depth] )
{return xml_path_exist( path, parameters );}


template< int depth >
inline string
solver_wavychannel::get_string( path_t (&path)[depth] )
{
  string s;
  get_from_xml( path, &s );
  return s;
