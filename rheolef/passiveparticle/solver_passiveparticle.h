 ...
 ***************************************************************************/
#ifndef SOLVER_PASSIVEPARTICLE_H
#define SOLVER_PASSIVEPARTICLE_H
...
/**
	@brief Solver for the particle Problem.
	@author Andreas Putz
...
//	XMLParser*  xmlparam;
	...
	*
	* - ellipsoid problem:
	*	-  "partvel" velocity of the particle
...
public:
//    solver_passiveparticle(XMLParser & xml_params);
    //changed by ali 11 Jun 2011
    solver_passiveparticle( std::string const& );

    ~solver_passiveparticle();
	void solve();
	///@name FE Methods
	//@{
	int FE_initialize();
